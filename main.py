...
async def orders(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for order in orders:
        ...
        keyboard.append([InlineKeyboardButton("رجوع للقائمة الرئيسية", callback_data='back_to_main')]) #added back button
...
async def button_click(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data.startswith('cat_'):
        ...
        if products:
            ...
            keyboard = [[InlineKeyboardButton("رجوع للقائمة الرئيسية", callback_data='back_to_main')]] #added back button
            reply_markup = InlineKeyboardMarkup(keyboard)
